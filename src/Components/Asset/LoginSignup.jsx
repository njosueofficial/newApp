...
function LoginSignup() {
  ...
  return (
    <div className='formContainer w-[522px] rounded-[5px] my-[5px] bg-gray-950 p-5'>
        ...
        <input type="text" className='p-[7px] px-[30px] rounded-[5px] outline-none w-[100%]' placeholder='Name' />
       </div>}
